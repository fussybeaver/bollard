...
impl Docker {
    ...
    ///
    /// See the [Docker API documentation](https://docs.docker.com/engine/api/v1.52/#operation/ImageGet)
    ...
    ///
    /// See the [Docker API documentation](https://docs.docker.com/engine/api/v1.52/#tag/Image/operation/ImageGetAll)
    /// for more information.
    /// # Arguments
