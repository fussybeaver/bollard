...
pub mod upload_server {
    ...
    #[async_trait]
    pub trait Upload: std::marker::Send + std::marker::Sync + 'static {
    ...
    impl<T> Clone for UploadServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "moby.upload.v1.Upload";
    impl<T> tonic::server::NamedService for UploadServer<T> {
