...
use bollard_llb::{
    copy, merge, mkdir, mkfile, rm, scratch, shlex, symlink, AddSecret, AddSshSocket,
    CacheSharingMode, FileOpts, Image, Local, MarshalOpts, MergeOpts, NetMode, Platform,
    ...
    assert_secret_exec_parity(
        ...
        || {
            alpine()
                ...
                .add_secret("token", AddSecret::new("token").with_as_env(true))
                .root()
                .unwrap()
                .marshal(MarshalOpts::linux_amd64())
                .unwrap()
    ...
    assert_secret_exec_parity(
        ...
        || {
            alpine()
                ...
                .add_secret("token", AddSecret::new("token").with_target("token"))
                .root()
                .unwrap()
                .marshal(MarshalOpts::linux_amd64())
                .unwrap()
    ...
    assert_secret_exec_parity(
        ...
        || {
            alpine()
                ...
                .add_secret(
                    "license",
                    AddSecret::new("license")
                        .with_target("/run/secrets/license")
                        .with_uid(1000)
                        .with_gid(1001)
                        .with_mode(0o440),
                )
...
#[test]
fn parity_ssh_default() {
    assert_go_parity(
        "ssh_default",
        include_bytes!("../testdata/golden/ssh_default.llb.pb"),
        || {
            alpine()
                .run(
                    RunOpts::new()
                        .with_arg("test")
                        .with_arg("-S")
                        .with_arg("/run/buildkit/ssh_agent.0")
...
#[test]
fn parity_ssh_explicit_ordering() {
    assert_go_parity(
            ...
            alpine()
                .run(
                    RunOpts::new()
                        ...
                        .with_mount_cache("/z", "cache-z", CacheSharingMode::Shared)
                        .with_mount_cache("/a", "cache-a", CacheSharingMode::Shared)
                        .with_ssh_socket(
                            AddSshSocket::new()
                                .with_id("deploy")
...
#[test]
fn parity_exec_network_host() {
    assert_go_parity(
        "exec_network_host",
        include_bytes!("../testdata/golden/exec_network_host.llb.pb"),
        || {
            alpine()
                .run(RunOpts::new().with_arg("true").with_net(NetMode::Host))
                .root()
                .unwrap()
                .marshal(MarshalOpts::linux_amd64())
                .unwrap()
...
#[test]
fn parity_exec_security_insecure() {
    assert_go_parity(
        ...
        || {
            alpine()
                .run(
                    RunOpts::new()
                        .with_arg("true")
                        .with_security(SecurityMode::Insecure),
                )
                .root()
                .unwrap()
                .marshal(MarshalOpts::linux_amd64())
